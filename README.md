...
A model for cell aggregation by diffusing signal molecules.
...
> [**“Come Together” - Chemotaxis in Dictyostelium discoideum**](https://www.complexity-explorables.org/explorables/come-together)

## Usage & Installation

### Just running the explorable

If you just want to run the explorable you can [**Click here.**](https://raw.githack.com/dirkbrockmann/come_together/main/dist/index.html)
...
cd come_together
npm init -y
npm install @explorables/come_together
npx http-server node_modules/@explorables/come_together/dist/ 
```
...
<html>
	<head>
		...
		<script src="https://cdn.jsdelivr.net/npm/@explorables/come_together/dist/index.umd.js"></script>
		...
	</head>
		...
	<body>
...
<html>
	<head>
		...
	    <script type="module">
	  	      import load from 'https://cdn.jsdelivr.net/npm/@explorables/come_together/dist/index.es.js';
	  	      const come_together = load("explorable_container");
	    </script>
	    <script nomodule src="https://cdn.jsdelivr.net/npm/@explorables/come_together/dist/index.umd.js"></script>	  
		...
	</head>
		...
	<body>
...
```shell
git clone https://github.com/dirkbrockmann/come_together.git
```
