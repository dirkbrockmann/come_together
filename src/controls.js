...
import toggle_advanced from "./toggle_advanced.js"
...
sliders[3].label("cAMP Pulse Strength")  // specific change for the recovery time slider
sliders[4].label("cAMP Life Time")  // specific change for the recovery time slider
sliders[5].label("cAMP Diffusion")  // specific change for the recovery time slider
